...
let ou_intro_g : 'a -> ('a, 'b) Either.t = fun _ -> failwith "à faire"
...
let imp_elim : ('a -> 'b) * 'a -> 'b = fun _ -> failwith "à faire"
let et_elim_g : 'a * 'b -> 'a = fun _ -> failwith "à faire"
let et_elim_d : 'a * 'b -> 'b = fun _ -> failwith "à faire"
...
let f1 : 'a -> 'a = fun _ -> failwith "à faire"
